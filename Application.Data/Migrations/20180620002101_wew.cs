        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>(maxLength: 256, nullable: false),
                    ControllerName = table.Column<string>(maxLength: 256, nullable: false),
                    ActionName = table.Column<string>(maxLength: 256, nullable: false),
                    MenuArea = table.Column<string>(maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ClaimType = table.Column<string>(maxLength: 1024, nullable: false),
                    ClaimValue = table.Column<string>(maxLength: 1024, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserClaim", x => x.UserId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<long>(nullable: false),
                    LoginProvider = table.Column<long>(maxLength: 256, nullable: false),
                    ProviderKey = table.Column<long>(maxLength: 256, nullable: false),
